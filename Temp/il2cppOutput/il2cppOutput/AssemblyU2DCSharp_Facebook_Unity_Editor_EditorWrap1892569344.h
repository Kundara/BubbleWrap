...
struct  EditorWrapper_t1892569344  : public Il2CppObject
{
public:
...
public:
	inline static int32_t get_offset_of_callbackHandler_0() { return static_cast<int32_t>(offsetof(EditorWrapper_t1892569344, ___callbackHandler_0)); }
