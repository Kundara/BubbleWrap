...
struct  CustomLogger_t346728577  : public Il2CppObject
{
public:
...
public:
	inline static int32_t get_offset_of_logger_0() { return static_cast<int32_t>(offsetof(CustomLogger_t346728577, ___logger_0)); }
