...
struct  ShareDialogMode_t698979849 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(ShareDialogMode_t698979849, ___value___1)); }
